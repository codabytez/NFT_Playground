...
const NftCard: FC<{
  ...
  return (
    <div className="w-[400px] h-[563px] border border-[#121212] bg-white flex flex-col gap-6">
      <div className="w-[400px] h-[391px] ">
      ...
      <div className="flex flex-col gap-4 px-7">
        ...
        <span className="w-[340px] border border-[#121212]" />

        <div className="w-[340px] h-7 flex justify-between">
